...
#Сбор информации вне зависимости от OS
def commonOSInfo():
    pc_dict.clear()
...
def winOSInfo():
    ...
    for app in winapps.list_installed():
        ...
        # name='Windows Driver Package - DEVLINE LTD (DVRSE) Media  (05/13/2015 )',
        # version='05/13/2015 ',
        # install_date=None,
        # install_location=None,
        # install_source=None,
        # modify_path=None,
        # publisher='DEVLINE LTD',
        # uninstall_string='C:\\PROGRA~1\\DIFX\\B60D12~1\\dpinst.exe /u C:\\Windows\\System32\\DriverStore\\FileRepository\\dvrs.inf_amd64_850a0d787d994d4b\\dvrs.inf')
